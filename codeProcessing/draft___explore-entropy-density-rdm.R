...
# TS1: white noise, full range
ts1 <- data.frame(DOI.hour = sort(c((1:365) + (10.5/24), (1:365) + (13.5/24))),
                  NDVI = runif(n = 365 * 2, min = 0, max = 1))
...
fig.name <- paste0('xplrfig__', zone_name, '__density-rdm')
