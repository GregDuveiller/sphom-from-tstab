...
# Purpose:  make figure showing the local example (near Rovieng in 2019)
# License:  GPL v3
...
iPixies <- data.frame(pixLbl = c('A','B','C','D'),
                      pixID = c(
                        ...
                        1220, 377, #2590,  # <---- these 2 were selected manually
...
fig.name <- paste0('fig___', 'local-TCI-ex3', '.', fig.fmt)
